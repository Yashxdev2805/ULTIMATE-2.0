    ...
    <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <GlassCard variant="interactive" glowColor="cyan" className="p-6 space-y-4">
          ...
          <h3 className="text-lg font-display font-bold dark:text-white text-slate-900">64-Bit Precision Driver Kit (S2 Steel)</h3>
          <p className="text-xs dark:text-slate-400 text-slate-600">Complete magnetic driver set with Pentalobe, Torx Security, Tri-point & Gamebit bits.</p>
        ...
        <GlassCard variant="interactive" glowColor="orange" className="p-6 space-y-4">
          ...
          <h3 className="text-lg font-display font-bold dark:text-white text-slate-900">Digital Thermal Soldering Workstation</h3>
          <p className="text-xs dark:text-slate-400 text-slate-600">Micro-soldering station with hot air rework gun, magnifying lamp, and solder flux.</p>
          <div className="pt-2 flex justify-between items-center">
